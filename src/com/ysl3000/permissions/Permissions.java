...
public class Permissions {
	...
	public static final Permission overrideVisibility = new Permission(
			"sst.cansee");
	...
	public static final Permission joinService = new Permission(
			"sst.joinservice");
	public static final Permission move = new Permission("sst.move");
	public static final Permission canChangeSpawnerType = new Permission(
			"sst.changetype");
